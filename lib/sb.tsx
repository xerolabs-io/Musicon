...
const sb = () => {
    return (
        <div className='h-full w-72 bg-transparent border-r border-neutral-900/40 
            relative overflow-hidden flex flex-col justify-between text-neutral-400 z-10'>
            ...
            <div className="relative z-10 p-6 flex flex-col gap-8 flex-1">
                ...
                <Link href={'/'}>
                    <div className='flex items-center gap-2.5'>
                        ...
                        <Image src={'/logoblue.svg'} alt='Muiscon Logo' width={42} height={42} className='object-contain' />
